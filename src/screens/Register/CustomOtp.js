...
import { View, TextInput, TouchableWithoutFeedback, Clipboard, Keyboard, Platform, StyleSheet } from 'react-native'
import PropTypes from 'prop-types'
import R from 'res/R';
const majorVersionIOS = parseInt(Platform.Version, 10);
const isAutoFillSupported = (Platform.OS === 'ios' && majorVersionIOS >= 12)

export default class CustomOtp extends Component {
    static propTypes = {
        ...
        return (
            <View pointerEvents="none" key={index + "view"}>
                <TextInput
                    ...
                    style={selectedIndex === index ? [styles.defaultTextFieldStyle, codeInputFieldStyle, codeInputHighlightStyle] : [styles.defaultTextFieldStyle, codeInputFieldStyle]}
